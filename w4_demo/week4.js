...
//VARIABLES - variabls store data (information)to be used in the script/program; they are friendly names to refer to info as//think aboutvariables as contact names in your phone: you dont need to remember everyone's number, just their name; the phone gets the number through the name

// each variable will store the answer to a riddle question
//JS requires vars to be declared as such
var store1 =  "The Horse was Named Friday" //answer to question 1
...
//              total, is not Total, is not TOTAL

//FUNCTIONS - perform tasks; they have a set of processes assigned to them, and when they are CALLED their tasks are performed

//function below will talk to the HTML DOM (Document Object Model) and get specific elements by their id, then push info to their innerHTML (in between the open and close of the tag)
